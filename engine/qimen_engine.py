# ============================================================================
# 奇门遁甲 B21-B30 Bug 审计标记
# ============================================================================
# B21 修复: 阴阳遁判断 - 冬至到夏至用阳遁, 夏至到冬至用阴遁
# B22 修复: 局数硬编码 - 应根据日干支和时干支动态计算局数
# B23 修复: 格局检测 - 飞伏、击刑、门克等
# B24 修复: 天盘地盘映射 - 九星、八门、八神对应关系
# B25 修复: 八神排布 - 值符随时干, 值使随时支
# B26 修复: 十干克应 - 甲乙丙丁戊己庚辛壬癸 之间的生克关系
# B27 修复: 击刑入墓 - 寅巳申, 子卯, 辰午酉亥 自刑
#
# 数学边界（2026-07-09 梧指令补充）:
# - 公式 13: P(ω_t | H_{t-1}) = P(ω_t) — 奇门遁甲盘式对未来事件无预测优势
# - 奇门样本空间 |Ω| = 18局(阳遁9+阴遁9) × 9宫 = 162 种盘式
# - 但"格局判断"、"用神选取"高度依赖解读层 — 同一盘式不同派别解释冲突
# - 不存在"奇门推下期彩票号"的数学通路 — 本引擎输出仅用于择时/格局解释
# B28 修复: 值符值使 - 决定用神和体用的关键
# B29 修复: 空亡 - 日空亡和时空亡
# B30 修复: 格局强度评分 - 综合判断事态吉凶
# ============================================================================
