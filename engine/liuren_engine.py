# ============================================================================
# 大六壬 B31-B40 Bug 审计标记
# ============================================================================
# B31 修复: 天盘排布 - 月将加占时支顺/逆行
# B32 修复: 四课排法 - 第一课(日上神/日阴阳), 第二课(辰上神/辰阴阳)
# B33 修复: 三传取法 - 贼克法/知一法/蒿矢法/弹射法
# B34 修复: 天将排布 - 贵人起例(月将加占时定位贵人)
# B35 修复: 课格分类 - 12 神课 (元首、重审...)
# B36 修复: 吉凶判断 - 根据三传和天将综合判断
# B37 修复: 月将判断 - 根据出生月份确定
#
# 数学边界（2026-07-09 梧指令补充）:
# - 公式 13: P(ω_t | H_{t-1}) = P(ω_t) — 大六壬课式对未来事件无预测优势
# - 大六壬样本空间 |Ω| = 12天盘 × 三传取法(贼克/知一/蒿矢/弹射约 6 种) × 12天将 = 复杂组合
# - 但"三传取法"、"天将解读"高度依赖解读层 — 同一课式不同派别解释冲突
# - 已知缺陷: 本引擎在测试中出现"四课为空" — 某些时辰边界条件下三传取法未覆盖
# - 不存在"大六壬推下期彩票号"的数学通路 — 本引擎输出仅用于占问解释
# B38 修复: 时辰换日 - 子时换日规则
# B39 修复: 空亡 - 旬空亡对三传的影响
# B40 修复: 神煞 - 月厌、天目、皇恩等
# ============================================================================
