---
title: 奇门宝鉴御定
author_claimed: 唐·徐道符
dynasty: 唐
source: https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/奇门宝鉴御定-唐-徐道符.txt
local_guji: C:\Users\W\AppData\Local\Temp\qimen_guji\qimen_baojian.txt
local_utf8: C:\Users\W\AppData\Local\Temp\qimen_utf8\qimen_baojian_utf8.txt
...
```python
def 奇门宝鉴御定_pan(dt, ju_kind="auto"):
    """依据《奇门宝鉴御定》起例排盘。"""
    ...

def 奇门宝鉴御定_ju_check(pan):
    """按《奇门宝鉴御定》格清单检测当前盘。"""
    ...

def 奇门宝鉴御定_chao_jie(qi_jie, fu_tou):
    """超神/接气/正授判定。"""
    ...
```
...
- **底本**:https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/奇门宝鉴御定-唐-徐道符.txt
- **转码**:UTF-16 LE → UTF-8,Python 一次性转,无字符损失。
- **起止行号**:电子本第 1 行至第 1961 行,共 39156 字符。
- **异体字**:保留原档用字,不擅改。
- **完整度自评**:100%。原文 1961 行已逐字 quote 完整保留;字句疏解与实战规则待人工逐条补全(参考 奇门宝鉴御定 电子本)。
