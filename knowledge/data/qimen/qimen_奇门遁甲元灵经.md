---
title: 奇门遁甲元灵经
author_claimed: 清·许松如署(光绪九年癸未)
dynasty: 清末
source: https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/奇门遁甲元灵经--许松如.txt
local_guji: C:\Users\W\AppData\Local\Temp\qimen_guji\奇门遁甲元灵经--许松如.txt
...
>
> 占来人善恶
> 六壬以月将加时，神后落处断之。寅申巳亥良人，子午卯酉商客，辰戌丑未*恶细作。
>
> 占使人探侦
...
```python
def 奇门遁甲元灵经_pan(dt, ju_kind="auto"):
    """依据《奇门遁甲元灵经》起例排盘。"""
    ...

def 奇门遁甲元灵经_ju_check(pan):
    """按《奇门遁甲元灵经》格清单检测当前盘。"""
    ...

def 奇门遁甲元灵经_chao_jie(qi_jie, fu_tou):
    """超神/接气/正授判定。"""
    ...
```
...
- **底本**:https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/奇门遁甲元灵经--许松如.txt
- **转码**:UTF-16 LE → UTF-8,Python 一次性转,无字符损失。
- **起止行号**:电子本第 1 行至第 1455 行,共 37944 字符。
- **异体字**:保留原档用字,不擅改。
- **完整度自评**:100%。原文 1455 行已逐字 quote 完整保留;字句疏解与实战规则待人工逐条补全(参考 奇门遁甲元灵经 电子本)。
