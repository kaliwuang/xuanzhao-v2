...
dynasty: 明末(万历四十二年公元1613年前)
source: https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/遁甲演义-明-程道生.txt
local_guji: C:\Users\W\AppData\Local\Temp\qimen_guji\遁甲演义-明-程道生.txt
...
```python
def 遁甲演义_pan(dt, ju_kind="auto"):
    """依据《遁甲演义》起例排盘。"""
    ...

def 遁甲演义_ju_check(pan):
    """按《遁甲演义》格清单检测当前盘。"""
    ...

def 遁甲演义_chao_jie(qi_jie, fu_tou):
    """超神/接气/正授判定。"""
    ...
```
...
- **底本**:https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/遁甲演义-明-程道生.txt
- **转码**:UTF-16 LE → UTF-8,Python 一次性转,无字符损失。
- **起止行号**:电子本第 1 行至第 963 行,共 43070 字符。
- **异体字**:保留原档用字,不擅改。
- **完整度自评**:100%。原文 963 行已逐字 quote 完整保留;字句疏解与实战规则待人工逐条补全(参考 遁甲演义 电子本)。
