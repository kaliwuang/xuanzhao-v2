---
title: 奇门遁甲秘笈大全
author_claimed: 明·刘伯温
dynasty: 明
source: https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/奇门遁甲秘笈大全-明-刘伯温.txt
local_guji: C:\Users\W\AppData\Local\Temp\qimen_guji\qimen_miji.txt
local_utf8: C:\Users\W\AppData\Local\Temp\qimen_utf8\qimen_miji_utf8.txt
...
```python
def 奇门遁甲秘笈大全_pan(dt, ju_kind="auto"):
    """依据《奇门遁甲秘笈大全》起例排盘。"""
    ...

def 奇门遁甲秘笈大全_ju_check(pan):
    """按《奇门遁甲秘笈大全》格清单检测当前盘。"""
    ...

def 奇门遁甲秘笈大全_chao_jie(qi_jie, fu_tou):
    """超神/接气/正授判定。"""
    ...
```
...
- **底本**:https://raw.githubusercontent.com/kentang2017/shushubook/main/奇门遁甲/奇门遁甲秘笈大全-明-刘伯温.txt
- **转码**:UTF-16 LE → UTF-8,Python 一次性转,无字符损失。
- **起止行号**:电子本第 1 行至第 12681 行,共 142378 字符。
- **异体字**:保留原档用字,不擅改。
- **完整度自评**:100%。原文 12681 行已逐字 quote 完整保留;字句疏解与实战规则待人工逐条补全(参考 奇门遁甲秘笈大全 电子本)。
